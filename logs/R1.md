...
## Day 39 - June 11, 2022
All sorting algos today. I think that's all my brain knows anymore! Radix sort is still giving me some problems but I think it's just because of how different it is to the others. Almost halfway!

# Day 40 - June 12, 2022
More on searching algorithms today! Most of my time was spent debugging though, not the most fun day I've had so far for sure. 

# Day 41 - June 13, 2022
Started working on the file I/O parts of my meal planner app! Next is to make a scraper that'll fill out some of this for me.

# Day 42 - June 14, 2022
Continued work on the text files this app will need. Wayyyyy too much data entry, I'm definitely going to have that taken care of for me. 

# Day 43 - June 15, 2022
Switched gears and worked with stacks and queues in C++ today! Created an algorithm that finds palindromes for practice.

# Day 44 - June 16, 2022
Read some more on stacks and queues. Still trying to get a better feel for them as I didn't spend too much time with them in Java.

# Day 46 - June 18, 2022
Finally finished my palindrome algorithm after so much debugging. Note to self: stop overthinking it!

# Day 50 - June 22, 2022
Halfway through! Been practicing for my algorithm midterm this week. Feeling pretty good about it though!

# Day 61 - July 3, 2022
I spent the past 10 days traveling but continuing my learning where I could! Mostly reading through my c++ textbook and using online compilers. Now that I'm home I'm ready to really put some work in to finish up this 100 days!

 # Day 62 - July 4, 2022
 Since I spent quite some time vacationing, I opted to work through the holiday today! Feels good to be back at my home setup. Today I created a small app that identifies info from VIN numbers!

 As I put yesterday, I'm ready to put all the work in I can this Summer. I have been recieving some not great news surrounding my personal life but instead of shutting down, I've decided to use it to ignite that passion I have. I would like to have a form of the meal prep planner (in a simpler form that is) up by Day 75. Approaching 3/4's of the way done I don't feel like I have anything in my repos to really be proud of. Of course I can point employers to my log but I haven't done anything that is unexpected, this Summer has been mostly learning! In fact, this has been my largest update in a month which has me a bit dissapointed in myself. Looks like I've been learning not just how to code, but also how I code as well. 

 # Day 63 - July 5, 2022
 Worked with pointers and creating my own data structures in C++ today!

 Pointers were a totally new concept for me and while I've definitely been aware of them, it wasn't something I remember dealing with a whole lot in my java classes. Not sure all the use cases for using them just yet, I also don't really think in terms of C++ either. I've enjoyed learning more and more about it but I see myself sticking with Python and Java going forward after this Summer. 

 # Day 64 - July 6, 2022
 Finished up the section on data structures by creating a program that creates a deck of cards using enumerators and custom data structures. Had a lot of fun with this one, enumerators were new!

 In my actual data structures and algorithms class I'm struggling with a bug that's keeping me from completing an assignment. Unfortunately this may set back my graduation as if I don't figure it out, I'm not sure I'll have the points required to pass the class. Not giving up yet, but it is absolutely a setback. I can't say I don't understand the content but the way this class is structured just does not work well for me!

 # Day 65 - July 7, 2022
 Started learning about tree structures in c++! Heavy project coming off this chapter, as in 10+ files heavy... woof. How do you practice different structures and algorithms?

 This is the first structure to really stump me. It could just be the way the textbook lays it out (and the fact that we have to use the textbook's half implemented project files - not enjoying this way of learning!) but it looks like there's a whole lot going on here! If I really want to get into the professional world I should probably start spending some free time cracking away at leetcode and really knowing the ins and outs here.

 # Day 66 - July 8, 2022
 Continued working with my binary tree project today, hoping to finish it up tomorrow! Also made some headway on personal projects. That meal planner should be ready soon!

 Definitely not looking forward to putting in the time to make this project work tomorrow but a better me exists on the other side of it and that's the whole point of this anyway right? I think my impatience to make it into the professional world has caused me to lose sight of what's important right now.

 # Day 67 - July 9, 2022
 More work on the binary tree project, reaaaaaaaally gonna have to keep practicing these and just hope that I'm not asked to implement one during my first interview hahaha. Heaps up next!

 # Day 68 - July 10, 2022
 Finished my C++ midterm with a small project that tracks your favorite albums of the year! After that I pivoted over to Java and put some real work in on the meal planner. Lots of file I/O today!

 Feels great to know I haven't lost my touch with Java, can't wait to come back to it full time soon!

 # Day 69 - July 11, 2022
 Felt like giving myself a refresher on git today so that's exactly what I did! Played around with my repo for my meal planner project.

 # Day 70 - July 12, 2022
 Learned heaps today! I know they're similar in implementation but they came so much faster than binary trees did. 

 # Day 71 - July 13, 2022
 Put some serious work on the meal planner today. The app now generates the recipes into text files and saves them in appropriate folders by meal type. Really proud of myself for comin up with this!

 I know I said I wanted to add it by Day 75 but I'm not sure I want this on my github anymore. Maybe its something I can fully develop and bring to market? I think I've got a lot of good ideas here and at the very least I wanna share it amongst my family. I suppose open source code is never a bad thing however.

 # Day 72 - July 14, 2022
 Worked on more advanced file operations in C++ today. I would say "learned" if I hadn't just made a whole system to read and write recipe files the other day. Practice is practice though!

 I think I definitely prefer writing to files in Java but then again I've had well over a year of doing that already under my belt. I don't dislike C++ as much as I might have at the start of the Summer but I definitely think I'm going to opt for Java over it still. 

 # Day 73 - July 15, 2022
 Played around with classes in C++ today! Also fixed my advanced file operations project. I do like the way C++ handles file operations over Java I think... so it has that!

 Granted the project was a simple one but I feel like reading and writing to files is just a lot less wordy than it is in Java. I also like some of the member functions like tellp and tellg. I'm sure Java has something like that but it wasn't taught to us so it would be new to me! I think given its been this long, that Java is gonna stay my favorite for now. 

 # Day 74 - July 16, 2022
 Playing with GUIs today! Feels like it's been years since the last time I messed around with this stuff.

 # Day 75 - July 17, 2022
 More GUI's today! Working on a pane in my input form that creates new fields upon the push of a button by a user. Definitely more of a backend than frontend guy hahaha!

 While I could definitely just go the route of scene builder or something, I feel that the best thing I can do here is create my own custom implementations and I'm not sure how easy that is to do under something like that. Knowing how to code in JavaFx might be valuable anyways.

 # Day 76 - July 18, 2022
 Played around with some custom classes relating to my GUI's. Also, while "code" related, I've starting reading into home lab projects!

 # Day 77 - July 19, 2022
 Got a new laptop today so I've been getting it connected to Github and to my personal repos at home! Also worked a little bit on the meal planner as well!

 # Day 78 - July 20, 2022
 Finishing up my C++ course, all the regular projects and exams are done. Just need to come up with an idea for my Final project and this one's in the bag!

 It is so nice having a setup with a laptop that I can take my code on the go and still come home to a full triple monitor setup! Finally starting to feel the part a bit more.

 # Day 79 - July 21, 2022
 Worked on the functionality of the meal planner today. I'm really close to having a fully built out console version of what I want!

 I think once I hit that version is when I'll put it up on here. Then I can track my learning of GUI's in commits going forward.

 # Day 80 - July 22, 2022
 Working more on GUIs today. Glad I learned about model view controller last spring as it's helping me conceptualize how to put this together soooo very nicely.

 # Day 81 - July 23, 2022
 Worked with graphs in C++ today. Trying to implement them with both an adjacency list and an adjacency matrix.

 # Day 82 - July 24, 2022
 Finished up graphs! Played with switching an adjacency list between unweighted and weighted.

 # Day 84 - July 26, 2022 
 Two more days of data entry and testing my GUI's. Not made much further progress but I needed to take the time to start inputting all of this anyway!

 # Day 85 - July 27, 2022
 Started working on a new personal project that'll help me keep track of assignments and other important information during school as I approach my final year of my CS degree!

 # Day 86 - July 28, 2022
 Worked some more with binary trees in c++! I switched it up and then started doing some career research. I really like what I've read on Dev Ops and could definitely see myself in that kind of role!

 # Day 87 - July 29, 2022
 Read some more on careers today. I want to really hit the applications hard this semester and try to have something lined up before I graduate.
 
 # Day 92 - August 2, 2022
 Coming down to the end here. I've spent the last 2 days working on dockerfiles ahead of my homelab setup. Plan is to install Ubuntu Server and then just containerize everything else I want on it!

 # Day 93 - August 3, 2022
 Played with an apache webserver container today to start off my homelab containers! Going to make a website that is only accessible from within the network.