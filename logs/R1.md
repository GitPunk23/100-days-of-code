...
## Day 4 - May 7, 2022
Continuing on with the Web Dev course, I dealth with more JS events today. I got to play around with the different kinds of events that can be fired including mouse events and keypress events. Pretty simple stuff but it was a nice review! As for new material, I also covered handlebars.js today. The handlebars library allows you to edit HTML documents through javascript and even includes conditional handling within HTML. I feel like this makes a lot of concepts I had thought before as difficult, seem a lot easier. Ready to move on to Intermediate Javascript from here!